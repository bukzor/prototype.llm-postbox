...
that pull is the only one the invariant survives. A task boundary is
the moment the recipient chooses; a pointer is what may travel without
consent where a body may not.
