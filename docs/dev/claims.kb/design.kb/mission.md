...
One person, working through claude-code sessions, and the agents that
orchestrate on their behalf. Today that person avoids delegating at all:
it goes wrong often, and a delegate lacks what a session has. The
mechanism exists so they stop avoiding it, for three uses at once.
